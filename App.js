...
import { StyleSheet, Text, View, Image, Switch, Modal, Pressable, SafeAreaView, Button} from "react-native";
  ...
  return(
    ...
    <View>
      <Image
          style={page.tinyLogo}
          source={{
            uri: 'https://images.pexels.com/photos/6008071/pexels-photo-6008071.jpeg?cs=srgb&dl=pexels-mo-eid-6008071.jpg&fm=jpg'
          }}
        />
      <Text style={flattenStyle}>Daniel Cortés</Text>
      <Text>Estilo:</Text>
